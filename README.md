...
| | |
|---|---|
| OCR recognition, warm | **4.5–13 ms** per grab of a fixture window; 4.5–6.4 ms (median 5.1) against the 476×319 canvas fixture |
...
| Launch of a command that dies at once | 0.34 s to `LaunchFailed` |
